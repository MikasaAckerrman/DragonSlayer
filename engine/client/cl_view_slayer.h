...
// ---------------------------------------------------------------------------
// Cvars accessible from other modules
// ---------------------------------------------------------------------------
...
// Applies ducktap, autostrafe, autojump and SGS combo logic to the
// current usercmd. Called from CL_CreateCmd after V_SlayerCamSnapCheck.
